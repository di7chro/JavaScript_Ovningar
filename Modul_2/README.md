1. Skapa en funktion som adderar två tal och returnerar svaret.  När sidan laddas skall sidan visa vad 2+2 blir med hjälp av den nya funktionen (använd alert() men lägg den inte i funktionen).
